...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8511205513:AAGAv0X3r_zOHGoT1NT-078CShw7qY2m0nM")
API_ID = int(os.environ.get("API_ID", "22632049"))
API_HASH = os.environ.get("API_HASH", "dc8d39eb6762bbd5fa74abe452c14d85")


OWNER_ID = int(os.environ.get("OWNER_ID", "5185252387"))
DB_URL = os.environ.get("DB_URL", "mongodb+srv://rajasekar93828_db_user:IdXwfTX0tJDLNUmM@cluster0.jvjoxqa.mongodb.net/?appName=Cluster0")
...
try:
    ADMINS=[5185252387]
    for x in (os.environ.get("ADMINS", "5185252387").split()):
        ADMINS.append(int(x))
except ValueError:
